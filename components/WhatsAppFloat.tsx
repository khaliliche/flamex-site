export default function WhatsAppFloat() {
  return (
    <a href="https://wa.me/212706560249" target="_blank" rel="noopener noreferrer" className="fixed bottom-6 right-6 z-50 bg-[#25D366] w-14 h-14 rounded-full flex items-center justify-center shadow-lg shadow-black/50 hover:scale-110 transition" aria-label="Contacter sur WhatsApp">
