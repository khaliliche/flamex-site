export function generateWhatsAppLink(items: { name: string; price: number }[], buyerInfo: { nom: string; telephone: string; adresse: string }) {
...
Adresse: ${buyerInfo.adresse}`
  ...
  return `https://wa.me/212706560249?text=${encoded}`
}